...
-- Inserts de prueba para la tabla del Banguat
...
-- Inserts de prueba para la tabla del WeatherAPI
INSERT INTO weather_gt (weather_date, location_key, lat, lon, temp_c, feels_c, humidity_pct, condition, description, provider)
