CREATE DATABES IF NOT EXISTS almacenamiento;
USE almacenamiento;

-- Tabla para guardar datos que vienen de la API de Banguat
...
-- Tabla para guardar datos que vienen de la API de OpenWeather
